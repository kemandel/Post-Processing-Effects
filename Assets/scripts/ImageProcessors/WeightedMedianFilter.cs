...
[CreateAssetMenu(fileName = "Image Processors", menuName = "Weighted Median Filter", order = 1)]
public class WeightedMedianFilter : ImageProcessor
{
    const string SHADER_NAME = "Unlit/WeightedMedianFilter";
